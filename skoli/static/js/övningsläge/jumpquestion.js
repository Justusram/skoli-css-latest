...
function swapQuiz(event) {
    ...
    clickedQuestion.className = "question-link link-clicked";

    const questionId = clickedQuestion.value;


    var url = `http://127.0.0.1:8000/api/question/${questionId}`;
    ...
    .then(function(data){
        ...
        //Get question description img, display the button to show it, if the question has a description img
