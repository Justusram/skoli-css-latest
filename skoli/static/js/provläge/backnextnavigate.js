...
function backOneQuestion(event) {
    ...
    var url = `http://127.0.0.1:8000/api/last-question-provläge/${questionId}`;
    ...
    .then(function(data){
        ...
        for (const questionLink of questionLinks) {
            ...
            if (questionLink.value == data.question.id) {
                questionLink.className = "question-link clicked";
            }
        }
...
function nextQuestion(event) {
    ...
    var url = `http://127.0.0.1:8000/api/next-question-provläge/${questionId}`;
